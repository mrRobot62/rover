...
# Hartes Abbrechen einer laufenden Launch
Es kann vorkommen, das sich mit CTRL-C die Prozesse nicht direkt beenden und noch Zombie-Prozesse im System vorhanden sind oder das CTRL-C überhaupt keine Wirkung zeigt

mit `pkill -9 ros2` bricht man hart alle laufenden ros2-Prozesse ab.

Hin und wieder sieht man solche Ausgaben im terminal:
```
1751397816.591142 [0]        tev: ddsi_udp_conn_write to udp/192.168.0.200:7413 failed with retcode -1
1751397817.591212 [0]        tev: ddsi_udp_conn_write to udp/192.168.0.200:7413 failed with retcode -1
1751397818.591285 [0]        tev: ddsi_udp_conn_write to udp/192.168.0.200:7413 failed with retcode -1
1751397819.591359 [0]        tev: ddsi_udp_conn_write to udp/192.168.0.200:7413 failed with retcode -1
1751397820.591442 [0]        tev: ddsi_udp_conn_write to udp/192.168.0.200:7413 failed with retcode -1
1751397821.591502 [0]        tev: ddsi_udp_conn_write to udp/192.168.0.200:7413 failed with retcode -1
```
dann kann man nur noch mit `pkill -9 ros2` arbeiten
